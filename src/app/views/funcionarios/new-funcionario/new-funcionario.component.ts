...
newFuncionarios:FormGroup;
  ...
  public addNewFunc(){
    if(this.newFuncionarios.valid){
   const funcionarioNovo:Funcionario = this.newFuncionarios.value
   this.funcionarioService.create(funcionarioNovo).subscribe(
    resposta=>{
